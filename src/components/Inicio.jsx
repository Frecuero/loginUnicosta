        ...
        <div className='row mt-3    '>
            <div className='col-sm-12 col-lg-4'>
                ...
                <div className='ms-2'>
                    ...
                    src="https://sfingenieria.com.co/wp-content/uploads/2019/10/foto_bloq_11.png" 
            ...
            <div className='col bg-warning bg-opacity-75 rounded-start col-lg-4 mt-5'>
                ...
                <div className='row m-2'>
                    El 3 de enero de 1971, el nuevo centro inició labores en la carrera 42F No. 75B-169 de esta ciudad, ofreciendo los programas de Arquitectura, Administración, Derecho e Ingeniería Civil, con una matrícula de 154 estudiantes. El traslado a su sede actual, Calle 58 No. 55-66, se verificó en enero de 1974.
                    Su personería jurídica fue otorgada el 23 de abril de 1971, mediante la Resolución No. 352 de la Gobernación del Atlántico.
                </div>
                <div className='row m-2'>
